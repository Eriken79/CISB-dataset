...
# Add vertical lines between test categories
...
ax.set_title("Enhanced Experiment (x86-64)")
...
ax.text(0.42, legend_y, '✓', color='green', fontsize=symbol_size, ha='center', va='center', transform=ax.transAxes)
ax.text(0.44, legend_y, ': CISB Present', color='black', fontsize=text_size, ha='left', va='center', transform=ax.transAxes)
