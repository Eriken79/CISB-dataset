...
const struct cl_option cl_options[] =
{
  ...
  { "-Wall",
    0,
    N_OPTS, 4,
    CL_C | CL_CXX | CL_Fortran | CL_Java | CL_ObjC | CL_ObjCXX | CL_REJECT_NEGATIVE,
    0, CLVC_BOOLEAN, 0 },
  { "-Wampersand",
  ...
  { "-ffixed-form",
    ...
    OPT_ffixed_, 11,
    CL_C | CL_Fortran | CL_ObjC,
    0, CLVC_BOOLEAN, 0 },
  { "-ffixed-line-length-",
    "-ffixed-line-length-<n>		Use n as character line width in fixed mode",
    OPT_ffixed_, 19,
    CL_C | CL_Fortran | CL_ObjC | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER,
    0, CLVC_BOOLEAN, 0 },
  { "-ffixed-line-length-none",
    "Allow arbitrary character line width in fixed mode",
    OPT_ffixed_line_length_, 23,
    CL_C | CL_Fortran | CL_ObjC | CL_REJECT_NEGATIVE,
    0, CLVC_BOOLEAN, 0 },
  { "-ffloat-store",
    "Don't allocate floats and doubles in extended-precision registers",
    N_OPTS, 12,
